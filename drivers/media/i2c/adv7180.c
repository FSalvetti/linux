...
#define ADV7182_REG_INPUT_VIDSEL			0x02
...
static int adv7180_set_std(struct adv7180_state *state, unsigned int std)
{
	...
	return i2c_smbus_write_byte_data(client, ADV7180_REG_INPUT_CONTROL,
		(std << 4) | state->input);
}
...
static int adv7182_set_std(struct adv7180_state *state, unsigned int std)
{
	...
	return i2c_smbus_write_byte_data(client, ADV7182_REG_INPUT_VIDSEL,
		std << 4);
}
